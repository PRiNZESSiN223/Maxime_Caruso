...
let projektArray : Projekt[];
 projektArray=[projekt1,projekt2,projekt3];

    
     function generateProjektOverview(): void {
      
         let inhalt:string = "";
        let node : any = document.getElementById("contentProjekte");
